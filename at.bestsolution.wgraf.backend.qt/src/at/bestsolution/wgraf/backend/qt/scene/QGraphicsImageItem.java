...
public class QGraphicsImageItem extends QGraphicsPixmapItem implements QGraphicsItemInterfaceWithTapEventReceiver{
...
//		dbgChooser = !dbgChooser;
	...
	public String toString() {
		return "QGraphicsImageItem("+boundingRect()+")@" + System.identityHashCode(this);
	}
}
