...
public class SimpleText extends Widget {
	...
	public SimpleText (CharSequence text, Skin skin) {
		this(text, skin.get(LabelStyle.class));
	}

	public SimpleText (CharSequence text, Skin skin, String styleName) {
	 ...
	 * color. */
	public SimpleText (CharSequence text, Skin skin, String fontName, Color color) {
	 ...
	 * skin. */
	public SimpleText (CharSequence text, Skin skin, String fontName, String colorName) {
		this(text, new LabelStyle(skin.getFont(fontName), skin.getColor(colorName)));
	}

	public SimpleText (CharSequence text, LabelStyle style) {
	...
	public void layout () {
		...
		// always use top left
		// we need to add the ascent
		y += -getBitmapFontCache().getFont().getAscent();
...
//		if (!cache.getFont().isFlipped()) y += bounds.height;
	...
	/** The style for a label, see {@link SimpleText}.
	 * @author Nathan Sweet */
